sap.ui.define([
	...
	return UIComponent.extend("sap.ui.demo.cart.Component", {
		...
		init: function () {
			...
			oProdModel.setDefaultBindingMode("OneWay");
			this.setModel(oProdModel, "det");

			// set cart model Mongo
			var oCartmModel = new JSONModel({});
			oCartmModel.setDefaultBindingMode("OneWay");
			this.setModel(oCartmModel, "cart");
			
			// set cart model Mongo
			var oMongoCartModel = new JSONModel(); 
			oMongoCartModel.setDefaultBindingMode("OneWay");
			this.setModel(oMongoCartModel, "sCart");
